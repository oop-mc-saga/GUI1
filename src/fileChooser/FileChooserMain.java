...
public class FileChooserMain extends javax.swing.JFrame {
    ...
    public FileChooserMain() {
        initComponents();
        applicationName=FileChooserMain.class.getSimpleName();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FileChooserMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
